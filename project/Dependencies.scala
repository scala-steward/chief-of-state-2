...
object Dependencies {
  ...
  object Versions {
    ...
    val PekkoProjectionVersion: String      = "1.0.0"
    val PostgresDriverVersion: String       = "42.7.5"
    val SlickVersion: String                = "3.5.2"
    val PekkoPersistenceJdbcVersion: String = "1.1.0"
    val ScalaMockVersion: String            = "6.1.1"

    val JaninoVersion: String                          = "3.1.12"
    val LogstashLogbackVersion: String                 = "8.0"
    val OpenTelemetrySdkVersion: String                = "1.45.0"
    val TestContainers: String                         = "0.41.5"
    val OpenTelemetrySdkConfigVersion: String          = "1.45.0"
    val OpenTelemetryInstrumentationApiVersion: String = "2.11.0"
    val OpenTelemetrySdkTestingVersion: String         = "1.45.0"
    val OpenTelemetryExtensionVersion: String          = "1.45.0"
    val OpenTelemetryApiVersion: String                = "1.45.0"
